...
var exploreServicesBtn = document.getElementById('explore-services-btn');
...
if (footerServicesLink) {
    footerServicesLink.addEventListener('click', toggleServicesDropdown);
}
if (exploreServicesBtn) {
    exploreServicesBtn.addEventListener('click', toggleServicesDropdown);
}
...
document.addEventListener('click', function(e) {
    ...
    var footerServicesLink = document.getElementById('footer-services-link');
    var exploreServicesBtn = document.getElementById('explore-services-btn');
    if (navServicesItem && dropdown && !navServicesItem.contains(e.target) && e.target !== footerServicesLink && e.target !== exploreServicesBtn) {
